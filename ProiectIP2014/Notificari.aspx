        ...
        <asp:LoginView ID="LoginView1" runat="server">
            <RoleGroups>
                <asp:RoleGroup Roles="ONG">
                    <ContentTemplate>
                        <asp:Label ID="Raspuns" runat="server" Text=" "></asp:Label><br /><br />
                        ...
                        <asp:ListView ID="ListView1" DataSourceID="SqlDataSource1" runat="server">
                            ...
                            <ItemTemplate>
                                <p id="itemPlaceholder" runat="server">Organizatia <a href="#"> <%# DataBinder.Eval(Container.DataItem,"nume_colab") %></a> vrea sa devina colaborator la proiectul <a href="Proiect.aspx?id_proiect=<%# DataBinder.Eval(Container.DataItem,"id_proiect") %>"> <%# DataBinder.Eval(Container.DataItem,"nume") %></a></p>
                                <div class="btn-group">
                                   <asp:Button ID="acepta"  runat="server" Text="Accepta" OnCommand="acepta_Command" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"id_proiect") %>' CommandName='<%# DataBinder.Eval(Container.DataItem,"cod_user") %>'  class="btn btn-primary" />
                                </div>
                            </ItemTemplate>
                        </asp:ListView>
